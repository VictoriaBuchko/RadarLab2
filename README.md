...
![Graph update after config](screenshots/fig5_update.png)
...
### 3.2 Колірне кодування хвоста цілі

Колір кожної точки визначається її **віком** — свіжі точки мають яскравий червоний колір, а старіші поступово тьмяніють до темно-зеленого. Це створює виразний кольоровий хвіст, який наочно показує траєкторію руху цілі. Використана колірна шкала:
